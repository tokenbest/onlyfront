...
import { Image, Heading, RowType, Toggle, Text } from '@tokenbest/uikit'
...
import { getFarmApr, getFarmApy } from 'utils/apy'
...
const Farms: React.FC = () => {
  ...
  const rowData = farmsStaked.map((farm) => {
    ...
    const row: RowProps = {
      ...
      apy: {
        value: farm.apy && farm.apy.toLocaleString('en-US', { maximumFractionDigits: 2,maximumSignificantDigits: 10 }),
        multiplier: farm.multiplier,
        lpLabel,
        tokenAddress,
        quoteTokenAddress,
