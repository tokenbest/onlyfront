...
import { Toast, toastTypes } from '@tokenbest/uikit'
...
export const useFetchPublicData = () => {
  ...
  useEffect(() => {
    console.log(`state.hooks.useFetchPublicData---<${slowRefresh}`)
...
export const useFarmUser = (pid) => {
  ...
  // console.log(`state.hooks--->${JSON.stringify(farm.userData ? farm.userData:'')}`)
  return {
    allowance: farm.userData ? new BigNumber(farm.userData.allowance) : new BigNumber(0),
    tokenBalance: farm.userData ? new BigNumber(farm.userData.tokenBalance) : new BigNumber(0),
    stakedBalance: farm.userData ? new BigNumber(farm.userData.stakedBalance) : new BigNumber(0),
    stakedFreeAmount: farm.userData ? new BigNumber(farm.userData.stakedFreeAmount) : new BigNumber(0),
    stakedLocks: farm.userData ? farm.userData.stakedLocks : [],
